  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <p className="mb-2">Upload Doc</p>

          <div className="flex items-center gap-6 relative">
            <label htmlFor="pdfUpload" className="cursor-pointer relative">
              {/* Upload Icon OR PDF Icon */}
              <img
                className="w-20"
                src={
                  !pdfFile
                    ? assets.upload_area // your upload icon
                    : assets.pdficon // add a pdf icon here
                }
              />
            ...
            {/* Cross Button to Remove PDF */}
            {pdfFile && (
              <button
                type="button"
                onClick={() => setPdfFile(null)}
                className="absolute top-0 left-[40px] bg-black text-white rounded-full w-6 h-6 flex items-center justify-center text-sm shadow-md"
              >
                ×
              </button>
            )}
